...
const modeloPedidos = require ('../models/pedidos.js')  //importo los modelos de las tablas a utilizar 
const modeloConsumos = require ('../models/consumos.js')  
const modeloInsumos = require ('../models/insumos.js')  
